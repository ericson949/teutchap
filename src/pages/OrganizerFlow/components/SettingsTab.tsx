    ...
    <div className="space-y-8 pb-32 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.div 
          ...
          className="bg-white/[0.02] p-8 rounded-[32px] border border-white/[0.08] space-y-6 backdrop-blur-2xl relative overflow-hidden"
        >
          ...
          <div className="flex gap-4 relative z-10">
            <button onClick={copyLink} className="flex-1 bg-white text-black py-4 rounded-full font-bold uppercase text-[9px] tracking-[0.2em] flex items-center justify-center space-x-2 hover:bg-white/90 transition-all active:scale-95">
              <Copy size={14} />
              <span>Copier le lien</span>
            </button>
            <button onClick={shareWhatsApp} className="flex-1 bg-white/10 text-white border border-white/20 py-4 rounded-full font-bold uppercase text-[9px] tracking-[0.2em] flex items-center justify-center space-x-2 hover:bg-white/20 transition-all active:scale-95">
        ...
        <motion.div 
          ...
          className="bg-white/[0.02] p-8 rounded-[32px] border border-white/[0.08] space-y-6 backdrop-blur-2xl"
        >
      ...
      <motion.div 
        ...
        className="bg-red-500/[0.02] border border-red-500/10 p-8 rounded-[32px] space-y-6 relative overflow-hidden"
      >
