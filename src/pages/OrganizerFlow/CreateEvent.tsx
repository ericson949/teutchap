...
export default function CreateEvent() {
  ...
  return (
    <div className="min-h-screen bg-[#08060d] text-white flex flex-col items-center p-4 md:p-8 selection:bg-primary/30 relative">
      ...
      <div className="w-full max-w-xl relative z-10 space-y-8 md:space-y-12 py-10 md:py-20 will-change-transform">
        <div className="text-center space-y-4 md:space-y-8 animate-in fade-in slide-in-from-top-8 duration-1000">
          <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 px-6 py-2.5 rounded-full backdrop-blur-md md:backdrop-blur-xl animate-float">
            ...
            <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.25em] text-gray-300">Expérience Premium</span>
          </div>
        ...
        <div className="glass rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-14 shadow-2xl space-y-8 md:space-y-10 border border-white/5 relative overflow-hidden group animate-in fade-in zoom-in-95 duration-700 delay-300 fill-mode-both will-change-transform">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 blur-[60px] md:blur-[100px] -mr-32 -mt-32 rounded-full group-hover:bg-primary/20 transition-all duration-1000" />
